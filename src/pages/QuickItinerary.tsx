        ...
        <div className="max-w-4xl w-full">
          ...
          <div className="text-center">
            ...
            <p
              ...
              style={{ lineHeight: '1.6', textShadow: '0 2px 15px rgba(0, 0, 0, 0.8)' }}
            >
              Get three personalized weekend plans — budget, balanced, or luxe — in under 30 seconds.
            </p>
              ...
              <div className="pt-4">
                <p className="text-white/60 text-sm">
                  ...
                  <button
                    ...
                    className="text-luxury-teal hover:text-luxury-orange transition-colors underline"
                  >
                    Create an account
                  </button>
                </p>
